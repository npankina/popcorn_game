...
//------------------------------------------------------------------------------------------------------------
AFont::AFont(int height, int weight, int family, const wchar_t *face_name, bool is_italic = false)
{
	LOGFONT log_font{};
...
const AFont AsConfig::Game_Over_Font(-60, 700, 66, L"Comic Sans MS", true); // MV Boli
